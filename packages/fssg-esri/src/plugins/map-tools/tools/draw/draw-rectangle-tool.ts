...
export type IDrawRectangleToolOptions = IDrawToolOptions
export type IDrawRectangleToolEvents = IDrawToolEvents

export class DrawRectangleTool<
  T_OPTIONS extends IDrawRectangleToolOptions = IDrawRectangleToolOptions,
  T_EVENTS extends IDrawRectangleToolEvents = IDrawRectangleToolEvents,
> extends DrawTool<T_OPTIONS, T_EVENTS> {
  ...
  protected override initAction_ () : this {
    this.action_ = this.draw_.create('rectangle', { mode: 'click' })
