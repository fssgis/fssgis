 ...
 * 基类配置项接口
 */
export interface IBaseClassOptions { // eslint-disable-line
...
export abstract class BaseClass<
  T_OPTIONS extends IBaseClassOptions = IBaseClassOptions,
  T_EVENTS extends IBaseClassEvents = IBaseClassEvents
> extends Observable<T_EVENTS & IBaseClassEvents> {
